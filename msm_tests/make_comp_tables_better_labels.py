...
id_string = 'sprocket_msm_big_compare'
suptitle_prefix = 'Sprocket Other Algorithms Comparison '

file_name_list = ['test_batch_0', 'test_batch_1', 'test_batch_2', 'test_batch_3', 'test_batch_4']
...
visualize_four_matrices(matrices_for_visual, plot_titles, save_prefix='agg_corr_stats', labels=label_list, suptitle=suptitle_prefix + "Ensemble Analysis Grids")
all_ag_type_avgs = {}
all_alg_types = {}
...
suptitle='CD and Best Performances'
...
plt.xscale('log')
# Customize the plot
plt.xlabel('Unitless Time Predicted = (|Train|+|Test|)*Channels*Length*log_b(Length)')
plt.ylabel('Time Observed (Seconds)')
plt.title('Predicted VS Observed Sprocket Tranform Times')
